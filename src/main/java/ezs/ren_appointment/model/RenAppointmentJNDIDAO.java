...
public class RenAppointmentJNDIDAO implements RenAppointmentDAO_interface {
	...
	private static final String FIND_BY_MEM = "SELECT * FROM `CFA104G5`.`REN_APPOINTMENT` WHERE apt_mem_id = ? ORDER BY apt_timestamp DESC";
