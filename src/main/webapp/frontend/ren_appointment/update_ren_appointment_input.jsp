...
<title>預約訂單資料修改 - update_ren_appointment_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>預約訂單資料修改 - update_ren_appointment_input.jsp</h3>
...
<FORM METHOD="post" 
	ACTION="<%=request.getContextPath()%>/RenAppointmentServlet.do" name="form1">
<table>
	<tr>
		<td>預約訂單ID:<font color=red><b>*</b></font></td>
		<td><%=renAppointmentVO.getAptId()%></td>
	</tr>
	<tr>
		<td>會員ID:</td>
		<td><input type="TEXT" name="aptMemId" value="<%=renAppointmentVO.getAptMemId()%>" /></td>
	</tr>
	<tr>
		<td>房東ID:</td>
		<td><input type="TEXT" name="aptLddId" value="<%=renAppointmentVO.getAptLddId()%>" /></td>
	</tr>
	<tr>
		<td>房源ID:</td>
		<td><input type="TEXT" name="aptLisId" value="<%=renAppointmentVO.getAptLisId()%>" /></td>
	</tr>
	<tr>
		<td>預約單狀態:</td>
		<td><input type="TEXT" name="aptStatus" size="1" value="<%=renAppointmentVO.getAptStatus()%>" /></td>
	</tr>
	<tr>
		<td>預約時間:</td>
