...
<html>
<head>
<title>所有收藏 - listAllRenFavorites.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>所有收藏 - listAllRenFavorites.jsp</h3>
...
<table>
	...
	<c:forEach var="renFavoritesVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/ren_favorites/ren_favorites.do" style="margin-bottom: 0px;">
