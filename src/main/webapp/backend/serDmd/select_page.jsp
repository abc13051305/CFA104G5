...
<body bgcolor='white'>
	...
	<ul>
		<li><a href='<%=request.getContextPath()%>/backend/serDmd/listAllSerDmd.jsp'>List</a>
			all Dmd. <br> <br></li>
		...
		<li>
			<FORM METHOD="post"
				ACTION="<%=request.getContextPath()%>/ser_dmd/SerDmdServlet.do">
				<b>選擇需求人姓名編號:</b> <select size="1" name="serDmdID">
					<c:forEach var="serDmdVO" items="${serDmdDao.all}">
	...
	<ul>
		<li><a href="<%=request.getContextPath()%>/backend/serDmd/addSerDmd.jsp">Add</a> a new Ser Demand.</li>
	</ul>
